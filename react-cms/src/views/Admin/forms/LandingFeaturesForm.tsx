...
export const LandingFeaturesForm: React.FC = () => {
  ...
  useEffect(() => {
    loadContent('features').then((data) => {
      if (data) {
        setFormData(data as FeaturesData);
      }
    });
  }, []);
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            {formData.features.map((feature, index) => (
              <div key={index} className="p-6 bg-gray-50 rounded-lg border-2 border-gray-200 space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Icon identifier (e.g., rocket, code, lock, cloud, heart, star)
                  </p>
                </div>
